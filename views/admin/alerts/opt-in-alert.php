...
<div class="avfw-alert">
    ...
    <div class="avfw-alert__buttons">
        <div class="avfw-alert__inner">
            <a class="avfw-button--accent avfw-button avfw-button--bounce"
               href="<?php echo avfw_fs()->get_reconnect_url(); ?>"><?php _e( 'Activate Plugin!',
					'age-verification-screen-for-woocommerce' ); ?></a>

            <a class="avfw-button avfw-button--default" href="<?php echo $contactUsUrl; ?>"><?php _e( 'Contact us',
					'age-verification-screen-for-woocommerce' ); ?></a>
        </div>
    </div>
</div>